...
const steps = [
  {
    slug: 'agents/audit-homepage',
    image: '/images/step1.png',
    altText: 'Introduction to the Audit Homepage feature in CorZen',
    title: 'Improve Your Homepage',
    description: 'Boost conversion with optimized headers, CTAs, and content sections.',
    intro: true,
    hotspot: null,
  },
  {
    slug: 'agents/audit-homepage/detail',
  ...
  },
  {
    ...
    hotspot: { top: '20%', left: '50%', align: 'center', cardWidth: '300px' },
  },
];
  ...
  return (
    ...
    <div className="rounded-xl bg-white overflow-hidden font-sans" style={{ border: '3px solid #0f172a', boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
      ...
      <div className="bg-slate-50 border-b border-slate-200 p-3 flex items-center justify-center">
        <span className="font-bold text-slate-900 text-sm tracking-tight">Agent Demo to Audit Your Homepage</span>
      </div>
